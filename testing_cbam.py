...
def test_model(model, test_loader):
    ...
    checkpoint_path = os.path.join(sftp_utils.sftp_path,'media/Data/2d_annot_model_lbc/dataset/checkpoint_folder_lbc_resnet50_cbam/best_model_fold_1.pth')
...
csv_file_path = os.path.join(sftp_utils.sftp_path,"media/Data/2d_annot_model_lbc/dataset/final_test_data_otsu.csv")
...
metrics_all_folds_df.to_csv(os.path.join(sftp_utils.sftp_path,'media/Data/2d_annot_model_lbc/dataset/test_metrics_cbam.csv'), index=False)
