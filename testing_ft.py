...
def test_model(model, test_loader):
    ...
    checkpoint_path = os.path.join(sftp_utils.sftp_path,'media/dataset/annot_cases_cpap/data/checkpoint_folder_cpap_resnet50_ft_aug/best_model_fold_4.pth')
...
metrics_all_folds_df.to_csv(os.path.join(sftp_utils.sftp_path,'media/dataset/annot_cases_cpap/data/test_metrics_ft2.csv'), index=False)
