...
def test_model(model, test_loader):
    ...
    checkpoint_path = os.path.join(sftp_utils.sftp_path,'media/Data/2d_annot_model_lbc/dataset/checkpoint_folder_lbc_resnet18_SA_rectfd_2_gray_resnet50_focal_loss/best_model_fold_4.pth')
