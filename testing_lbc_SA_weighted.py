...
def test_model(model, test_loader):
    ...
    checkpoint_path = os.path.join(sftp_utils.sftp_path,'media/Data/2d_annot_model_lbc/dataset/checkpoint_folder_lbc_resnet18_SA_weighted_rectfd_2_gray/best_model_fold_2.pth')
...
metrics_all_folds_df.to_csv(os.path.join(sftp_utils.sftp_path,'media/Data/2d_annot_model_lbc/dataset/test_metrics_lbc_resnet18_SA_new_rectf_2.csv'), index=False)
