    ...
    def train(self, train_loader, val_loader, num_epochs, learning_rate, fold, latest_epoch, checkpoint_folder=None, resume=False, early_stopping_patience=10):
        ...
        for epoch in range(start_epoch,num_epochs):
            ...
            for image, label in train_loader:
                ...
                loss1 = criterion(outputs[0], label[0])
...
def test_model(model, test_loader, fold):
    ...
    checkpoint_path = os.path.join(sftp_utils.sftp_path,f'media/Data/2d_annot_model_lbc/dataset/checkpoint_folder_lbc_resnet18_SA/best_model_fold_{fold}.pth')
...
checkpoint_folder = os.path.join(sftp_utils.sftp_path,'media/Data/2d_annot_model_lbc/dataset/checkpoint_folder_lbc_resnet18_SA_weightedloss_rectfd')
