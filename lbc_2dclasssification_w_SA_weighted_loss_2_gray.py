...
def test_model(model, test_loader, fold):
    ...
    checkpoint_path = os.path.join(sftp_utils.sftp_path,f'media/Data/2d_annot_model_lbc/dataset/checkpoint_folder_lbc_resnet18_SA_weighted_rectfd_2_gray/best_model_fold_{fold}.pth')
...
checkpoint_folder = os.path.join(sftp_utils.sftp_path,'media/Data/2d_annot_model_lbc/dataset/checkpoint_folder_lbc_resnet18_SA_weighted_rectfd_2_gray')
